...
import NumberModal from "@/app/components/ui/numberModal";
...
export default function RegistrationPage() {
    ...
    return (
        <div className="flex justify-center items-center p-5 min-h-screen">
                    ...
                    <div>
                        ...
                        <div className="text-center">
                            ...
                            <p className="text-gray-600 mb-6 text-sm">
                                Daftarkan akun Anda untuk mulai menggunakan platform kami.
                            </p>
                        </div>
                        ...
                        <form onSubmit={handleRegister} className="mt-5">
                            ...
                            <button
                                type="submit"
                                className="w-full bg-[#29616D] hover:bg-[#29616D]/90 text-white font-semibold py-2 px-4 rounded-md mt-4 transition-colors cursor-pointer"
                            >
                                Daftar
                            </button>
                        </form>
            ...
            <NumberModal isOpen={isModalOpen} onClose={() => setIsModalOpen(false)} />
        </div>
    );
}
